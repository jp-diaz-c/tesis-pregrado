...
```{r tabla-1, echo=FALSE, results='asis'}

knitr::kable(tabla_descriptivos, caption =  "Tabla 1. Estadísticas descriptivas") 
...
```{r grafico-1, fig.width=8, fig.height=6, out.width='100%', fig.align='center', fig.cap="Matriz de correlaciones", echo=FALSE}
...
```{r, results='asis', echo=FALSE, tab.cap="Regresiones multiples"}
...
```{r grafico-2, fig.width= 8, fig.height=6, out.width='100%', fig.align='center', fig.cap="Gráfico 2", echo=FALSE}
