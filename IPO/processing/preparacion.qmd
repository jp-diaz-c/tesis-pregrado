...
latbaro_2023 <- readRDS("C:/Users/jpdia/OneDrive/Documents/GitHub/tesis-pregrado/IPO/input/original/latinobarometro_2023.rds")
...
latbaro_filt <- latbaro_filt |> 
  ...
  rename(reduc_corrup_rec = reduc_corrup_2)
  
frq(latbaro_filt$reduc_corrup_rec)
descr(latbaro_filt$reduc_corrup_rec)

##Recodificación: 1 = Poco/Nada; 0 = Mucho/Algo

###Asimetría aceptable

#4.3 Percepción de la desigualdad de ingresos ----
...
latbaro_filt <- latbaro_filt |> 
  ...
  rename(just_distr_rec = just_distr_2)
  

frq(latbaro_filt$just_distr_rec)
descr(latbaro_filt$just_distr_rec)

## Recodificación: 1 = Muy injusta/injusta; 0 = Muy justa/justa

###Asimetría alta

#4.4 Confianza generalizada ----

frq(latbaro_filt$P9STGBS)
...
frq(latbaro_filt$REEEDUC_1)

latbaro_filt <- latbaro_filt |> 
  mutate(
    nivel_educ = REEEDUC_1 |> 
      as.numeric() |> 
...
latbaro_filt <- latbaro_filt |> 
  select(-c(P60ST, P17ST, P9STGBS, S1, S11, REEEDUC_1, S2, reduc_corrup_1, reduc_corrup_NA, just_distr_1, just_distr_NA, conf_gen_2, conf_gen_NA, sexo_1, nivel_educ_2 ))
...
## alpha = 0.78. Medidas sobre 0.7 son aceptables.
...
latbaro_filt <- latbaro_filt |> 
  ...
  ungroup() |> 
  mutate(perc_sitecon = (1 + ((perc_sitecon-3)*9 / (14-3)))
         )
...
## Todos los estadísticos de factor loading están sobre el 0.57.
